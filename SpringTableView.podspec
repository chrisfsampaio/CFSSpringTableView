#
#  Be sure to run `pod spec lint SpringTableView.podspec' to ensure this is a
...
does NOT support iOS version < 7.0
  ...
  s.homepage     = "https://github.com/chrisfsampaio/SpringTableView"
  ...
  s.source       = { :git => "https://github.com/chrisfsampaio/SpringTableView.git", :branch => "master" }
